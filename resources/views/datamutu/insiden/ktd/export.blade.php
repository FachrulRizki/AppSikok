...
@section('title', 'Rekap Laporan Insiden KTD')

@section('content')
<center>
    <h2 class="export-heading" style="margin-bottom: 5px;">REKAP LAPORAN INSIDEN KESELAMATAN PASIEN</h2>
    <h2 class="export-heading" style="margin-bottom: 5px;">KEJADIAN TIDAK DIINGINKAN (KTD)</h2>
...
<div class="export-break">
    ...
    <table class="export-table" style="margin-bottom: .5rem">
        ...
        <tr>
            ...
            <td class="export-separator">:</td>
            <td>{{ $item->poli }}</td>
            <th class="export-label-2">Akibat</th>
            <td class="export-separator">:</td>
            <td>{{ $item->akibat }}</td>
        </tr>
    </table>
