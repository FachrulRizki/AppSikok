                        ...
                        <div class="col-md-7 mb-4">
                            @can('insiden.export')
                                @if (request('triwulan') && request('tahun'))
                                    <a href="{{ route('insiden.ktd.export', ['triwulan' => request('triwulan'), 'tahun' => request('tahun')]) }}"
                        ...
                        <tbody>
                            @forelse ($ktds as $ktd)
                                <tr>
                                    ...
                                    <td>{{ $ktd->no_rm }}</td>
                                    <td>{{ $ktd->waktu_mskrs ? $ktd->waktu_mskrs->format('d-m-Y, H:i') . ' WIB' : '-' }}
                                    </td>
                                    <td>{{ $ktd->waktu_insiden ? $ktd->waktu_insiden->format('d-m-Y, H:i') . ' WIB' : '-' }}
                                    </td>
                                    <td>
                                        <div class="d-flex justify-content-center gap-2">
                                            @can('insiden.view')
                                                <a href="{{ route('insiden.ktd.show', $ktd->id) }}"
