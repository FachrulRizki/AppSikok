                ...
                <form action="" method="get">
                    <div class="row border-bottom align-items-end">
                        ...
                        <div class="col-md-4 mb-4">
                            @can('cuci_tangan.export')
                                @if (request('start') && request('end'))
                                    <a href="{{ route('cuci_tangan.export', ['start' => request('start'), 'end' => request('end')]) }}"
                                    class="btn btn-primary float-end" data-bs-toggle="tooltip" data-bs-placement="top" title="Export Excel"><i class="fa fa-download"></i></a>
                                @else
                                    <button type="button"
