                        ...
                        <div class="col-md-3 mb-4">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="search" value="{{ request('search') }}" name="search" class="form-control" placeholder="Judul Kegiatan">
                        ...
                        <div class="col-md-4 mb-4">
                            @can('refleksi.export')
                                @if (request('start') && request('end'))
                                    <a href="{{ route('refleksi.export', ['start' => request('start'), 'end' => request('end')]) }}"
