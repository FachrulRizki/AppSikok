                ...
                <form action="{{ route('kuesioner.store') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="date" name="waktu_survei" class="form-control @error('waktu_survei') is-invalid @enderror" value="{{ old('waktu_survei', date('Y-m-d')) }}">
                            @error('waktu_survei')
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" min="1" name="usia" class="form-control @error('usia') is-invalid @enderror">
                            @error('usia')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <select name="pendidikan" class="form-control form-select @error('pendidikan') is-invalid @enderror">
                                <option value="">-- Pilih --</option>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select name="hubungan_pasien" class="form-control form-select @error('hubungan_pasien') is-invalid @enderror">
                                <option value="">-- Pilih --</option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Bagaimana pendapat Saudara tentang kecepatan waktu dalam memberikan pelayanan<span class="text-danger">*</span></label>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Bagaimana pemahaman Saudara tentang kemudahan prosedur pelayanan di unit ini<span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Bagaimana pendapat Saudara tentang kewajaran biaya atau tarif dalam pelayanan<span class="text-danger">*</span></label>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Bagaimana pendapat Saudara tentang kesesuaian produk pelayanan
                                antara yang tercantum dalam standar pelayanan dengan hasil yang diberikan<span class="text-danger">*</span></label>
